...
const translations: Array<[string, string]> = [
  ...
  ['アプリ内バージョン表示を修正', 'Fixed the in-app version display'],
  ['バックエンドの古い固定バージョンが画面表示を上書きする問題を修正', 'Fixed an old hard-coded backend version overriding the displayed version'],
  ['Electron実行ファイルのバージョンを画面へ直接連携', 'Connected the Electron executable version directly to the UI'],
  ['package・exe・アプリ内表示が常に一致するように変更', 'Kept package, executable, and in-app versions synchronized'],
